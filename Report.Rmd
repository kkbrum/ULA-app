...
- Built the summary tab with Jon. In particular, I made the code more concise and provided two HTML formatting options depending on whether or not a particular field had a response.
- Helped debug and merge other peoples' code together.
