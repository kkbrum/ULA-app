...
# Fixes to Student.R
-Removed print outs
-Fixed mistake with loading preferences
-Instructions on preferences tab
-New field asking about availability during course meeting times

# Fixes to Faculty.R
-Log in disappears after logged in
-Fixed indenting of ranked students
-Preset number of ULAs in courses.csv
