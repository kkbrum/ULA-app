...
#### 6/06/18 21:45-22:45
Finished the error checking. Student app is in pretty good shape. Should make the in progress but saved applications have different file names (affects the log in functionality) than submitted ones. Need to conduct thorough testing of student app.
